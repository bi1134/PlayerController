...
namespace MatthewAssets
{
    ...
    {
        public ParticleSystem particleSystems; // Asigna el sistema de partículas en el Inspector
        ...
        {
            SetRandomRotation();
            particleSystems.Play(); // Inicia el sistema de partículas (opcional)
        }
        ...
        void SetRandomRotation()
        {
            ...
            particleSystems.transform.rotation = Quaternion.Euler(0f, 0f, randomZRotation);
        }
    }
}